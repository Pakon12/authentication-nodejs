...
export const signup = async (req, res) => {
    ...
    try {
        if (!email || !password || !name) {
            throw new Error("Plaese fill all fields");
        }
        ...
        // console.log(user.email ,verificationToken)
...
export const verifyEmail = async (req, res) => {
    ...
    try {
        ...
        if (!user) {
            res.status(400).json({ success: false, message: "Invalid or exprired verification code" });
        }
